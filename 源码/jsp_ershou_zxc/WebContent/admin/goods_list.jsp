...
<div class="container-fluid">
	...
	<div class="text-right"><a class="btn btn-warning" href="/admin/goods_add.jsp">添加二手自行车</a></div>

	<br>

	<ul role="tablist" class="nav nav-tabs">
		<li <c:if test="${type==0 }">class="active"</c:if> role="presentation"><a href="/admin/goods_list">全部二手自行车</a></li>
